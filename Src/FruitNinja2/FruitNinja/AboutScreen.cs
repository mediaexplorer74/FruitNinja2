  ...
  public class AboutScreen : HUDControl3d
  {
    ...
    public override void Draw(float[] tintChannels)
    {
      try
      {
        ...
        TheGame.instance.spriteBatch.DrawString(TheGame.instance.font3, str3, new Vector2(8f, 8f), Color.Black);
        TheGame.instance.spriteBatch.DrawString(TheGame.instance.font3, str3, new Vector2(7f, 7f), Color.BlanchedAlmond);
