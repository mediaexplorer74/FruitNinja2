...
// Type: FruitNinja2.AchievementsScreen
  ...
  internal class AchievementsScreen : HUDControl3d
  {
    ...
    public override void Draw(float[] tintChannels)
    {
      ...
      if (AchievementsScreen.m_box != null)
      {
        ...
        TheGame.instance.spriteBatch.Begin((SpriteSortMode) 1, BlendState.NonPremultiplied);
        TheGame.instance.spriteBatch.Draw(AchievementsScreen.m_box.intex, new Rectangle(-170, (int) num1, AchievementsScreen.m_box.intex.Width - AchievementsScreen.m_box.intex.Width / 16, AchievementsScreen.m_box.intex.Height), Color.White);
        TheGame.instance.spriteBatch.End();
      }
      TheGame.instance.spriteBatch.Begin((SpriteSortMode) 1, BlendState.NonPremultiplied);
      if (AchievementsScreen.m_live != null)
      ...
      for (int index = 0; index < 20; ++index)
      {
        ...
        foreach (string str4 in strArray)
        {
          ...
          Vector2 vector2_2 = TheGame.instance.font3.MeasureString(str5);
        ...
        if (!flag1)
        {
          TheGame.instance.spriteBatch.DrawString(TheGame.instance.font3, str1, new Vector2(100f, num11 + 16f), color);
          TheGame.instance.spriteBatch.DrawString(TheGame.instance.font3, AchievementManager.GetGamerScore(index).ToString(), new Vector2(510f, num11 + 16f), color);
        }
        bool flag2 = false;
        ...
        if (!flag2 && str2.Length > 0)
          TheGame.instance.spriteBatch.DrawString(TheGame.instance.font3, str2, new Vector2(100f, num11 + 36f), color);
        ...
        if (!flag3)
          TheGame.instance.spriteBatch.Draw(texture2D, new Rectangle(26, (int) num6, 64, 64 + num8), new Rectangle?(new Rectangle(0, num10, texture2D.Width, texture2D.Height + num9)), Color.White);
      }
      TheGame.instance.spriteBatch.End();
      TheGame.instance.spriteBatch.Begin((SpriteSortMode) 1, BlendState.NonPremultiplied);
      TheGame.instance.spriteBatch.Draw(AchievementsScreen.m_box.intex, new Rectangle(-170, (int) num1, AchievementsScreen.m_box.intex.Width - AchievementsScreen.m_box.intex.Width / 16, 137), new Rectangle?(new Rectangle(0, 0, AchievementsScreen.m_box.intex.Width, 137)), Color.White);
      TheGame.instance.spriteBatch.Draw(AchievementsScreen.m_box.intex, new Rectangle(-170, (int) num1 + 400, AchievementsScreen.m_box.intex.Width - AchievementsScreen.m_box.intex.Width / 16, 48), new Rectangle?(new Rectangle(0, 400, AchievementsScreen.m_box.intex.Width, 48)), Color.White);
      TheGame.instance.spriteBatch.End();
    }
