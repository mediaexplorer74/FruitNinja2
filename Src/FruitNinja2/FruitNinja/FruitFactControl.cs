...
// Type: FruitNinja2.FruitFactControl
...
namespace FruitNinja2
{
  public class FruitFactControl : HUDControl3d
  {
    ...
    public FruitFactControl()
    {
      ...
      this.m_leaderboardState = signedInGamer == null || !signedInGamer.IsSignedInToLive || !TheGame.logInSucceeded ? FruitFactControl.FFL.FFL_OFFLINE : FruitFactControl.FFL.FFL_DOWNLOADING;
    ...
    public override void Init()
    {
      ...
      if (this.m_showCombo)
      {
        FruitFactControl.zenModeTitle = string.Format(TheGame.instance.stringTable.GetString(136).Replace("%i", "{0}"), (object) Game.game_work.saveData.numFruitTypesInSliceCombo);
        ...
        FruitFactControl.zenModeTitle = TheGame.instance.stringTable.GetString(161);
      int num1 = 0;
      do
      {
        int num2;
    ...
    public override void Draw(float[] tintChannels)
    {
      ...
      if (this.m_drawOrder == HUD.HUD_ORDER.HUD_ORDER_POST)
      {
        ...
        if (TheGame.settings.language == 3 || TheGame.settings.language == 4)
      ...
      else
      {
        if (FruitFactControl.USE_ZEN_FACT_SCREEN)
        {
          ...
          Game.game_work.pGameFont.DrawString(
              TheGame.instance.stringTable.GetString(139), this.m_pos.X - 8f, this.m_pos.Y,
        ...
        else if (Game.game_work.gameMode == Game.GAME_MODE.GM_ARCADE && this.m_mode == 0)
        {
          ...
          Game.game_work.pGameFont.DrawString(TheGame.instance.stringTable.GetString(139), this.m_pos.X - 8f, this.m_pos.Y - (Game.game_work.language == StringTableUtils.Language.LANGUAGE_ENGLISH || Game.game_work.language == StringTableUtils.Language.LANGUAGE_ENGLISH_UK ? 0.0f : 4f), 0.0f, this.m_fruitColor, 16f, 0.0f, 0.0f, ALIGNMENT_TYPE.ALIGN_HCENTER);
    ...
    private void UpdateLeaderboard()
    {
      ...
      if (signedInGamer1 == null || signedInGamer1 != null && !signedInGamer1.IsSignedInToLive || !TheGame.logInSucceeded)
      {
    ...
    private void DrawLeaderboard()
    {
      ...
      {
        case FruitFactControl.FFL.FFL_NO_FRIENDS:
          str1 = TheGame.instance.stringTable.GetString(160);
          this.DrawXboxLive();
          break;
        case FruitFactControl.FFL.FFL_OFFLINE:
          str1 = TheGame.instance.stringTable.GetString(867);
          this.DrawXboxLive();
          break;
        case FruitFactControl.FFL.FFL_DOWNLOADING:
          if ((double) this.m_loadingSymbolTime >= 0.0 && FruitFactControl.s_loadingTexture != null)
          {
            ...
            string stringToDraw = TheGame.instance.stringTable.GetString(99);
      ...
      foreach (string str5 in strArray)
      {
        ...
        Vector2 vector2_2 = TheGame.instance.font3.MeasureString(str6);
      ...
      if (str2.Length > 0)
      {
        ...
        Vector2 vector2_3 = TheGame.instance.font3.MeasureString(str7);
        TheGame.instance.spriteBatch.DrawString(TheGame.instance.font3, str7, new Vector2(num4 - vector2_3.X / 2f, num5), color);
        num5 += num6;
      }
      if (str3.Length > 0)
      {
        string str8 = str3.Trim();
        Vector2 vector2_4 = TheGame.instance.font3.MeasureString(str8);
        TheGame.instance.spriteBatch.DrawString(TheGame.instance.font3, str8, new Vector2(num4 - vector2_4.X / 2f, num5), color);
        num5 += num6;
      }
      if (str4.Length > 0)
      {
        string str9 = str4.Trim();
        Vector2 vector2_5 = TheGame.instance.font3.MeasureString(str9);
        TheGame.instance.spriteBatch.DrawString(TheGame.instance.font3, str9, new Vector2(num4 - vector2_5.X / 2f, num5), color);
