  ...
  public class ShopListItem : ScrollingMenuItem
  {
    ...
    public override void Draw()
    {
      ...
      if (this.m_isOnScreen)
      {
        ...
        {
          TheGame.instance.stringTable.GetString(167),
          TheGame.instance.stringTable.GetString(166)
        };
        ...
        pGameFont.DrawString(TheGame.instance.stringTable.GetString(this.m_info.shopTitle),
