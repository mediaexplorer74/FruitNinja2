  ...
  public class MainScreen : HUDControl3d
  {
    ...
    public void LeaderboardsCallback()
    {
      ...
      if (1==0)//(Gamer.SignedInGamers[(PlayerIndex) 0] == null || !TheGame.logInSucceeded)
      {
        ...
        {
          Mortar.Game1.instance.stringTable.GetString(703)
        };
    ...
    private string NO => Mortar.Game1.instance.stringTable.GetString(702);
    ...
    private void ExitGameCallback(IAsyncResult result)
    {
      ...
      //else
      {
        ...
        catch
        {
                ...
                Mortar.Game1.exitingGame = true;
                Mortar.Game1.instance.Exit();
      }
    }
    ...
    public override void Update(float dt)
    {
      ...
      if (this.m_gamerProfileButton == null)
      {
        ...
        if (signedInGamer != null && signedInGamer.IsSignedInToLive && Mortar.Game1.picture != null && Mortar.Game1.logInSucceeded)
        {
          ...
          texture.w = (uint)Mortar.Game1.picture.Width;
          texture.h = (uint)Mortar.Game1.picture.Height;
      ...
      switch (this.m_state)
      {
        ...
        case MainScreen.MS.MS_WAIT:
          if (/*!Guide.IsVisible &&*/ Mortar.Game1.instance.BackButtonWasPressed)
          {
            string[] buttons = new string[2]
            {
              this.NO,
    ...
    public override void Draw(float[] tintChannels)
    {
      ...
      if (this.m_leaderBoardComingSoonTexture != null && this.m_newGame != null)
      {
        ...
        this.m_leaderBoardComingSoonTexture.UnSet();
            ...
            Mortar.Game1.instance.spriteBatch.Draw(this.m_live, new Vector2(MainScreen.liveX, MainScreen.liveY), Color.White);
