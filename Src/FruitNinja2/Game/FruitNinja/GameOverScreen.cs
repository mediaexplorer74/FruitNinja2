...
// Type: GameManager.GameOverScreen
            ...
            if ((double) Game2.game_work.gameOverTransition >= 0.99900001287460327)
            {
              if (!this.m_hasSetScore)
              {
                ...
                if (Game2.game_work.gameMode == Game2.GAME_MODE.GM_ARCADE)
                {
                  ...
                  if (num2 >= 10)
                  {
                    if (num1 != Mortar.Game1.settings.week)
                    {
                                            Mortar.Game1.settings.bestThisWeek = 0;
                                            Mortar.Game1.settings.week = num1;
                    }
                    if (Mortar.Game1.settings.bestThisWeek < currentScore)
                    {
                                            Mortar.Game1.settings.bestThisWeek = currentScore;
