...
// Type: GameManager.LeaderboardsScreen
  ...
  internal class LeaderboardsScreen : HUDControl3d
  {
    ...
    public override void Init()
    {
      ...
      if (this.m_modeClass == null)
      {
        ...
        Game2.game_work.hud.AddControl((HUDControl) this.m_modeClass);
      ...
      if (this.m_modeZen == null)
      {
        ...
        this.m_modeZen.Init();
        Game2.game_work.hud.AddControl((HUDControl) this.m_modeZen);
      ...
      if (this.m_modeArcade == null)
      {
        ...
        Game2.game_work.hud.AddControl((HUDControl) this.m_modeArcade);
      ...
      if (this.m_modeWeekly == null)
      {
        ...
        Game2.game_work.hud.AddControl((HUDControl) this.m_modeWeekly);
      ...
      if (this.m_modeTotalFruit == null)
      {
        ...
        Game2.game_work.hud.AddControl((HUDControl) this.m_modeTotalFruit);
    ...
    public override void Update(float dt)
    {
      ...
      switch (this.m_state)
      {
        case 0:
          ...
          {
            this.m_time = 1f;
            this.m_quitButton = new MenuButton("back_icon.tex", new Vector3((float) (425.0 - (double) Game2.SCREEN_WIDTH / 2.0), (float) ((double) LeaderboardsScreen.ABOUT_SCREEN_HEIGHT / 2.0 - 266.0), 0.0f), new MenuButton.MenuCallback(this.QuitGameCallback), Fruit.MAX_FRUIT_TYPES, Vector3.Zero, true);
          ...
          if (!this.slide_off)
          {
            ...
            if (reader != null)
            {
              for (int index1 = 0; index1 < reader.Entries.Count; ++index1)
              {
                ...
                if (this.gameMode == -2)
                {
                  int valueInt32 = 1000;//entry1.Columns.GetValueInt32("BestScore");
                  ...
                  this.entries.Add(new LeaderboardsScreen.LeaderboardData()
                  {
                    score = "1000",//entry1.Columns.GetValueInt32("BestScore").ToString(),
                    gamerTag = "gamertag",//entry1.Gamer.Gamertag,
                    isPlayer = false//string.Compare(entry1.Gamer.Gamertag, signedInGamer.Gamertag) == 0
                  });
              }
            }
            this.slide_on = true;
    ...
    public override void Draw(float[] tintChannels)
    {
      if (this.m_texture != null)
      {
        ...
        MatrixManager.GetInstance().Scale(new Vector3(440f * Game2.GAME_MODE_SCALE_FIX, 220f * Game2.GAME_MODE_SCALE_FIX, 1f));
        ...
        MatrixManager.GetInstance().Translate(new Vector3((float) LeaderboardsScreen.ABOUT_CENTRE_X - Game2.SCREEN_WIDTH / 2f, num3, 0.0f));
      ...
      if (LeaderboardsScreen.m_backing != null)
      {
                ...
                Mortar.Game1.instance.spriteBatch.Draw(LeaderboardsScreen.m_backing, new Vector2(0.0f, 0.0f), Color.White);
      ...
      if (LeaderboardsScreen.m_boxTexture != null && this.m_state == 7)
      {
        ...
        this.panelY = num4;
                Mortar.Game1.instance.spriteBatch.Begin((SpriteSortMode) 1, BlendState.NonPremultiplied);
                Mortar.Game1.instance.spriteBatch.Draw(LeaderboardsScreen.m_boxTexture.intex, new Vector2(-196f, num4), Color.White);
                Mortar.Game1.instance.spriteBatch.Draw(LeaderboardsScreen.m_caption[this.caption].intex, new Vector2(num9, 0.0f), Color.White);
                Mortar.Game1.instance.spriteBatch.Draw(LeaderboardsScreen.m_live, new Vector2(LeaderboardsScreen.liveX, LeaderboardsScreen.liveY), Color.White);
                Mortar.Game1.instance.spriteBatch.End();
      }
      if (this.m_state == 7)
      {
        ...
        foreach (LeaderboardsScreen.LeaderboardData entry in this.entries)
        {
              ...
              if (entry.gotWeekly || entry.isPlayer)
              {
                if (!this.slide_on)
                {
                  if ((double) num12 < 424.0)
                                        Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font2, entry.gamerTag, new Vector2((float)LeaderboardsScreen.TAB1, num12), !entry.isPlayer || this.slide_on ? Color.Black : new Color(200, 0, 0));
                }
                else
                                    Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font2, entry.gamerTag, new Vector2((float)LeaderboardsScreen.TAB1, num12), !entry.isPlayer || this.slide_on ? Color.Black : new Color(200, 0, 0));
                Vector2 vector2 = Mortar.Game1.instance.font1.MeasureString(entry.score);
                                Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font2, entry.score, new Vector2((float)LeaderboardsScreen.TAB3 - vector2.X / 2f, num12), Color.Black);
              }
              else
              {
                                Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font2, entry.gamerTag, new Vector2((float)LeaderboardsScreen.TAB1, num12), !entry.isPlayer || this.slide_on ? Color.Black : new Color(200, 0, 0));
                ...
                if ((double) num12 > (double) num13)
                {
                  ...
                  int h = (int) LeaderboardsScreen.m_noScoreThisWeek.h;
                                    Mortar.Game1.instance.spriteBatch.End();
                                    Mortar.Game1.instance.spriteBatch.Begin((SpriteSortMode) 1, BlendState.NonPremultiplied);
                                    Mortar.Game1.instance.spriteBatch.Draw(LeaderboardsScreen.m_noScoreThisWeek.intex, new Rectangle(LeaderboardsScreen.TAB3 - 68, (int) num12 - 16, w >> 1, (h >> 1) - num14), new Rectangle?(new Rectangle(0, 0, w, h - (num14 << 1))), Color.White);
                }
                else
                {
                                    Mortar.Game1.instance.spriteBatch.End();
                                    Mortar.Game1.instance.spriteBatch.Begin((SpriteSortMode) 1, BlendState.NonPremultiplied);
                                    Mortar.Game1.instance.spriteBatch.Draw(LeaderboardsScreen.m_noScoreThisWeek.intex, new Rectangle(LeaderboardsScreen.TAB3 - 68, (int) num12 - 16, (int) (LeaderboardsScreen.m_noScoreThisWeek.w / 2U), (int) (LeaderboardsScreen.m_noScoreThisWeek.h / 2U)), Color.White);
                }
              }
            }
            else
          ...
          ++num11;
                ...
                Mortar.Game1.instance.spriteBatch.End();
                Mortar.Game1.instance.spriteBatch.Begin((SpriteSortMode) 1, BlendState.NonPremultiplied);
                Mortar.Game1.instance.spriteBatch.Draw(LeaderboardsScreen.m_boxTexture.intex, new Rectangle(-196, (int) num4, 1024, 204), new Rectangle?(new Rectangle(0, 0, 1024, 204)), Color.White);
                Mortar.Game1.instance.spriteBatch.Draw(LeaderboardsScreen.m_boxTexture.intex, new Rectangle(-196, (int) num4 + 408, 1024, 48), new Rectangle?(new Rectangle(0, 408, 1024, 48)), Color.White);
                Mortar.Game1.instance.spriteBatch.End();
                Mortar.Game1.instance.spriteBatch.Begin((SpriteSortMode) 1, BlendState.NonPremultiplied);
        //SignedInGamer signedInGamer = default;//Gamer.SignedInGamers[(PlayerIndex) 0];
        if (1 == 0)//(signedInGamer != null)
        {
          if (this.gameMode < 0)
          {
            //Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font2, signedInGamer.Gamertag, new Vector2((float)LeaderboardsScreen.TAB1, (float)LeaderboardsScreen.TABLE_Y + num4), new Color(200, 0, 0));
            //string str = this.gameMode != -1 ? Mortar.Game1.settings.bestThisWeek.ToString() : Mortar.Game1.settings.tf.ToString();
            //Vector2 vector2 = Mortar.Game1.instance.font1.MeasureString(str);
            // Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font2, str, new Vector2((float)LeaderboardsScreen.TAB3 - vector2.X / 2f, (float)LeaderboardsScreen.TABLE_Y + num4), new Color(200, 0, 0));
          }
          else
          {
            //Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font2, signedInGamer.Gamertag, new Vector2((float)LeaderboardsScreen.TAB1, (float)LeaderboardsScreen.TABLE_Y + num4), new Color(200, 0, 0));
            //string str = Game2.game_work.saveData.highScores[this.gameMode].ToString();
            //Vector2 vector2 = Mortar.Game1.instance.font1.MeasureString(str);
            // Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font2, str, new Vector2((float)LeaderboardsScreen.TAB3 - vector2.X / 2f, (float)LeaderboardsScreen.TABLE_Y + num4), new Color(200, 0, 0));
          }
          if (Mortar.Game1.picture != null)
              Mortar.Game1.instance.spriteBatch.Draw(Mortar.Game1.picture, new Rectangle(LeaderboardsScreen.TAB1 - 48, (int) ((double)LeaderboardsScreen.TABLE_Y + (double) num4), 32, 32), new Rectangle?(new Rectangle(0, 0, 64, 64)), Color.White);
        }
        Mortar.Game1.instance.spriteBatch.End();
      }
      else if (this.m_state == 3 || this.m_state == 4 || this.m_state == 5)
      {
        ...
        {
          string str1 = Mortar.Game1.instance.stringTable.GetString(877);
          float num15 = 400f;
          float num16 = 220f;
          ...
          foreach (string str2 in strArray)
          {
            ...
            Vector2 vector2 = Mortar.Game1.instance.font1.MeasureString(str3);
                        Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font3, str3, new Vector2(num15 - vector2.X / 2f, num16), Color.Bisque);
            num16 += 30f;
          }
                    Mortar.Game1.instance.spriteBatch.End();
        }
      ...
      {
        string str4 = Mortar.Game1.instance.stringTable.GetString(878);
        float num17 = 400f;
        float num18 = 220f;
        ...
        foreach (string str5 in strArray)
        {
          ...
          Vector2 vector2 = Mortar.Game1.instance.font1.MeasureString(str6);
                    Mortar.Game1.instance.spriteBatch.DrawString(Mortar.Game1.instance.font3, str6, new Vector2(num17 - vector2.X / 2f, num18), Color.Bisque);
          num18 += 30f;
        }
                Mortar.Game1.instance.spriteBatch.End();
      }
