...
namespace Mortar
{
  public class StringTable
  {
    ...
    {
      this.name = filename;
      string[][] strArray = Game1.instance.Content.Load<string[][]>(filename + "_header.str");
    ...
    public void LoadLanguage(int lidx)
    {
      ...
      this.languages[lidx].strings = Game1.instance.Content.Load<string[]>(this.name + "_" + StringTable.langnames[lidx] + ".str");
