...
namespace Mortar
{
  public class Model
  {
    ...
    public void Draw(Matrix? mtx)
    {
      ...
      {
        Model.basicEffect = new BasicEffect(Game1.instance.GraphicsDevice);
      ...
      Game1.instance.GraphicsDevice.DrawUserPrimitives<VertexPositionColorTexture>((PrimitiveType) 1, this.vertecies, 0, this.vertecies.Length - 2);
    }
  }
}
