...
using Game = Microsoft.Xna.Framework.Game;//FruitNinja2.Game;

#nullable disable
namespace Mortar
{
  public class TheGame : Game//FruitNinja2.Game
  {
    ...
    private bool fadein;
    private FadeManager fm = new FadeManager(TheGame.bobsCousinHairyMaclary, TheGame.bobsCousinHairyMaclary);
    ...
    public static void SaveConfig()
    {
      ...
      try
      {
        ...
        TheGame.settings.language = 0;//(int) Game.game_work.language;
    ...
    private string ERROR_BUTTON_1 => TheGame.instance.stringTable.GetString(703);

    private string ERROR_TITLE_1 => TheGame.instance.stringTable.GetString(845);
    ...
    {
      return string.Format("Error 0x{0:x} occurred. Please check your memory usage before continuing.", (object) TheGame.GetErrorCode());
    }
    ...
    protected override void Initialize()
    {
      ...
      try
      {
        TheGame.emulator = true;//Environment.DeviceType == 1;
        if (!TheGame.emulator)
        {
      ...
      catch (Exception ex)
      {
        ...
        string text = TheGame.ERROR_MESSAGE(2147487744U);
    ...
    protected override void LoadContent()
    {
      try
      {
        ...
        TheGame.instance.GraphicsDevice.Clear((ClearOptions) 3, Color.Black, 1f, 0);
      ...
      catch (Exception ex)
      {
        ...
        while (innerException != null)
          innerException = innerException.InnerException;
        string text = TheGame.ERROR_MESSAGE(2147491840U);
      ...
      if (this.IsActive)
      {
        if (TheGame.instance.IsActive)
        {
          if (TheGame.switchLanguage)
          {
            ...
            switch (TheGame.switchToLanguage)
            {
          ...
          //try
          {
            ...
            if (TheGame.initupdates == 0)
            {
              if ((double) TheGame.loadinScreen < 5.0)
                TheGame.loadinScreen += 0.0333333351f;
              ...
              dt = 0.0333333351f * TheGame.dtCo;
              TheGame.fgame.Update(dt);
              AchievementManager.Update(gameTime);
              this.BackButtonWasPressed = false;
              float timeSinceLastUpdate = 0.0333333351f * TheGame.dtCo;
...
label_6:
      ...
      if (TheGame.m_fruitTex != null && TheGame.m_ninjaTex != null && TheGame.m_headTex != null && TheGame.m_bodyTex != null && this.spriteBatch != null)
      {
        ...
        this.spriteBatch.Draw(TheGame.m_ninjaTex, new Rectangle(240 + TheGame.m_fruitTex.Width + 40, 310, TheGame.m_ninjaTex.Width, TheGame.m_ninjaTex.Height), Color.White);
        this.spriteBatch.Draw(TheGame.m_bodyTex, new Rectangle(80, 220, TheGame.m_bodyTex.Width, TheGame.m_bodyTex.Height), Color.White);
    ...
    protected override void OnExiting(object sender, EventArgs args)
    {
      ...
      catch (Exception ex)
      {
        ...
        while (innerException != null)
          innerException = innerException.InnerException;
        string text = TheGame.ERROR_MESSAGE(2147495936U);
        string[] buttons = new string[1]
        {
          this.ERROR_BUTTON_1
        };
    ...
    protected override void OnActivated(object sender, EventArgs args)
    {
      ...
      catch (Exception ex)
      {
        ...
        while (innerException != null)
          innerException = innerException.InnerException;
        string text = TheGame.ERROR_MESSAGE(2147500032U);
        string[] buttons = new string[1]
        {
          this.ERROR_BUTTON_1
        };
    ...
    protected override void OnDeactivated(object sender, EventArgs args)
    {
      ...
      catch (Exception ex)
      {
        ...
        while (innerException != null)
          innerException = innerException.InnerException;
        string text = TheGame.ERROR_MESSAGE(2147504128U);
        string[] buttons = new string[1]
        {
          this.ERROR_BUTTON_1
        };
    ...
    protected void GamerSignedInCallback(object sender, SignedInEventArgs args)
    {
        ...
        if (gamer != null)
        {
          if (gamer.IsSignedInToLive)
          {
            ...
            if (gamer.Privileges.AllowProfileViewing != GamerPrivilegeSetting.Blocked && gamer.Privileges.AllowUserCreatedContent != GamerPrivilegeSetting.Blocked)
            {
              ...
              try
              {
                TheGame.picture = Texture2D.FromStream(this.graphics.GraphicsDevice, gamer.GetProfile().GetGamerPicture());
              }
              catch
              {
                TheGame.picture = (Texture2D) null;
              }
            }
            TheGame.logInSucceeded = true;
          }
          else
          {
            if (this.getAchievements)
      ...
      catch (Exception ex)
      {
        ...
        while (innerException != null)
          innerException = innerException.InnerException;
        string text = TheGame.instance.stringTable.GetString(867) + "\n 0x" + num.ToString("X");
        string[] buttons = new string[1]
        {
          this.ERROR_BUTTON_1
        };
